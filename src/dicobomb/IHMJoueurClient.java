...
public class IHMJoueurClient  extends Box implements ActionListener, Observer {
    ...
    */
    ...
    private JLabel nombreVie = new JLabel("1");
    private JLabel action = new JLabel("attente d'un adversaire ...");
    ...
    public IHMJoueurClient(JoueurClient joueur) {
        ...
        add(panneau);
//        panneau = new JPanel();
        panneau.add(new JLabel("nombre de vie"));
        panneau.add(nombrePoints);
        add(panneau);
